            ...
            <div className="col-12 footer-container d-flex flex-wrap">
                ...
                <div className="col-12 col-lg-4 offset-lg-8 d-flex flex-wrap p-3">
                    ...
                    <div className="col-xs-12 col-4 text-center">
                        <a className="text-white" href="https://www.facebook.com/ClubKonicu" title="Facebook"
                            target="_blank" rel="noopener noreferrer">
                            <FontAwesomeIcon icon={ faFacebookF } size="2x" />
                        </a>
                    </div>
                    <div className="col-xs-12 col-4 text-center">
                        <a className="text-white" href="https://www.instagram.com/clubkonicu/" title="Instagram" 
                            target="_blank" rel="noopener noreferrer">
                            <FontAwesomeIcon icon={ faInstagram } size="2x" />
                        </a>
                    </div>
                    <div className="col-xs-12 col-4 text-center">
                        <a className="text-white" href="https://open.spotify.com/show/2RErT6Z1u2xeT7B0AtZnqe" title="Spotify"
                            target="_blank" rel="noopener noreferrer">
